...
resource synapseWorkspace 'Microsoft.Synapse/workspaces@2021-05-01' = {
  ...
  resource linkedService1 'linkedservices@2018-06-01' = {
    ...
    properties: {
      type: 'AzureBlobFS'
      typeProperties: {
        url: 'https://asadatalaketr8595.dfs.core.windows.net'
        encryptedCredential: 'ew0KICAiVmVyc2lvbiI6ICIyMDE3LTExLTMwIiwNCiAgIlByb3RlY3Rpb25Nb2RlIjogIktleSIsDQogICJTZWNyZXRDb250ZW50VHlwZSI6ICJQbGFpbnRleHQiLA0KICAiQ3JlZGVudGlhbElkIjogIkFTQVdPUktTUEFDRVRSODU5NV9iZDQzZmVlOS0xMjg1LTQ2NDctODVhMS04ZjdkNWVhMTliOTEiDQp9'
      }
    }
  }
}
